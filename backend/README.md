...
## Project Structure
    ...
    ├── testapiautosetting_115636  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_115636`
...
2. Clone this repo and `cd testapiautosetting_115636`
